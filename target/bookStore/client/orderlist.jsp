										...
										<tr>
											...
											<td class="tableopentd03">
												...
												<c:if test="${order.paystate==0 }">
													<a href="${pageContext.request.contextPath}/client/user/removeOrderById.do?id=${order.id}">刪除</a>
												</c:if> 
												<c:if test="${order.paystate!=0 }">
													<a href="${pageContext.request.contextPath}/client/user/removeOrderById.do?id=${order.id}&flag=${order.paystate}">刪除</a>
												</c:if>
											</td>
										</tr>
									</c:forEach>
