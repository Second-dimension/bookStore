...
<%@taglib prefix="p" uri="http://lht.login-tag" %>
						...
						<td>
							<table width="100%" border="0" cellspacing="2" class="upline">
								...
								<tr>
									...
									<td><input type="password" class="textinput" id="password" name="password" value="${login_user.password}" onkeyup="checkPassword();"/></td>
									<td><span id="passwordMsg"></span><font color="#999999">密码设置至少6位，请区分大小写</font></td>
								</tr>
								<tr>
									<td style="text-align:right">重复密码：</td>
									<td><input type="password" class="textinput" id="repassword" name="repassword" value="${login_user.password}" onkeyup="checkConfirm();"/></td>
