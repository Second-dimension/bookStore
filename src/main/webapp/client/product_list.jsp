...
<%@taglib prefix="lht" uri="http://lht.pager-tags" %>
						...
						<tr>
							<td>
								...
								<div class="pagination">
									<ul>
										<lht:pager  pageIndex="${pageModel.pageIndex}"
													pageSize="${pageModel.pageSize}"
													recordCount="${pageModel.recordCount}"
													submitUrl="${pageContext.request.contextPath}/client/product/findProductByCategory.do?pageIndex={0}&name=${name}"/>
